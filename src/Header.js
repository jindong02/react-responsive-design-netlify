      ...
      <div>
        ...
        <section className="mb-10 pb-10">
          ...
          <div className="grid grid-cols-1 gap-4 rounded md:grid-cols-2 lg:xl:grid-cols-3">
            {/* Version 1.0.0 - 1st Jan 2021 */}
            <div className="p-7 flex justify-between group relative rounded-lg border border-gray-50 hover:bg-slate-50 shadow cursor-pointer transition-all ease-in-out delay-50 w-max-[300px]">
        ...
        <section className="mb-10 pb-10">
          <div className="flex justify-between items-center mb-5 pb-2 border-b border-b-primary">
            ...
            <div className="flex items-center justify-center flex-6 gap-4">
              ...
              />
              <button className="px-3 py-2 rounded-md  min-w-[120px] flex gap-2 justify-center undefined bg-primary text-white font-semibold">
                Add New
              </button>
            </div>
          </div>
                        ...
                        <div style={inside}>
                          ...
                          >
                            <g clip-path="url(#clip0)">
                              ...
                              <mask id="path2190590" fill="white">
                                <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
                        ...
                        <div style={inside}>
                          ...
                          >
                            <g clip-path="url(#clip0)">
                              ...
                              <mask id="path6772314" fill="white">
                                <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
                                  d="M183.886 150.917C183.859 150.801 183.831 150.685 183.803 150.569C183.776 150.454 183.748 150.338 183.719 150.222L167.323 81.7855C167.306 81.7177 167.29 81.6499 167.274 81.5821C167.258 81.5142 167.242 81.4465 167.225 81.3787L167.152 81.0752L167.151 81.0755C156.933 39.6308 115.156 14.1472 73.5821 24.1081C32.0078 34.0689 6.31547 75.7174 15.9883 117.293L15.9863 117.293L32.9776 188.211L32.9916 188.208C43.5944 229.112 85.0616 254.149 126.329 244.261C167.597 234.374 193.216 193.264 184.131 151.996L184.144 151.993L183.886 150.917Z"
                        ...
                        <div style={inside}>
                          ...
                          >
                            <g clip-path="url(#clip0)">
                              ...
                              <mask id="path4775979" fill="white">
                                <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
                                  d="M183.886 150.917C183.859 150.801 183.831 150.685 183.803 150.569C183.776 150.454 183.748 150.338 183.719 150.222L167.323 81.7855C167.306 81.7177 167.29 81.6499 167.274 81.5821C167.258 81.5142 167.242 81.4465 167.225 81.3787L167.152 81.0752L167.151 81.0755C156.933 39.6308 115.156 14.1472 73.5821 24.1081C32.0078 34.0689 6.31547 75.7174 15.9883 117.293L15.9863 117.293L32.9776 188.211L32.9916 188.208C43.5944 229.112 85.0616 254.149 126.329 244.261C167.597 234.374 193.216 193.264 184.131 151.996L184.144 151.993L183.886 150.917Z"
                        ...
                        <div style={inside}>
                          ...
                          >
                            <g clip-path="url(#clip0)">
                              ...
                              <mask id="path8562985" fill="white">
                                <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
                                  d="M183.886 150.917C183.859 150.801 183.831 150.685 183.803 150.569C183.776 150.454 183.748 150.338 183.719 150.222L167.323 81.7855C167.306 81.7177 167.29 81.6499 167.274 81.5821C167.258 81.5142 167.242 81.4465 167.225 81.3787L167.152 81.0752L167.151 81.0755C156.933 39.6308 115.156 14.1472 73.5821 24.1081C32.0078 34.0689 6.31547 75.7174 15.9883 117.293L15.9863 117.293L32.9776 188.211L32.9916 188.208C43.5944 229.112 85.0616 254.149 126.329 244.261C167.597 234.374 193.216 193.264 184.131 151.996L184.144 151.993L183.886 150.917Z"
                        ...
                        <div style={inside}>
                          ...
                          >
                            <g clip-path="url(#clip0)">
                              ...
                              <mask id="path1916376" fill="white">
                                <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
                                  d="M183.886 150.917C183.859 150.801 183.831 150.685 183.803 150.569C183.776 150.454 183.748 150.338 183.719 150.222L167.323 81.7855C167.306 81.7177 167.29 81.6499 167.274 81.5821C167.258 81.5142 167.242 81.4465 167.225 81.3787L167.152 81.0752L167.151 81.0755C156.933 39.6308 115.156 14.1472 73.5821 24.1081C32.0078 34.0689 6.31547 75.7174 15.9883 117.293L15.9863 117.293L32.9776 188.211L32.9916 188.208C43.5944 229.112 85.0616 254.149 126.329 244.261C167.597 234.374 193.216 193.264 184.131 151.996L184.144 151.993L183.886 150.917Z"
        ...
        {/* Ideas */}
        <section className="mb-10 pb-10">
          <div class="flex justify-between items-center mb-5 pb-2 border-b border-b-primary">
            <h1 class="text-3xl font-bold ">Ideas</h1>
            <div class="inline-flex border rounded-md " role="group">
              <button
                type="button"
                class="inline-flex items-center px-6 py-3 text-sm text-buttonGray  bg-primaryLight rounded-l-md false focus:z-10 focus:bg-primary focus:text-white text-lg"
              >
                New
              </button>
              <button
                type="button"
                class="inline-flex items-center px-6 py-3 text-sm text-buttonGray  bg-primaryLight false false focus:z-10 focus:bg-primary focus:text-white text-lg"
              >
                Updated
              </button>
              <button
                type="button"
                class="inline-flex items-center px-6 py-3 text-sm text-buttonGray  bg-primaryLight false rounded-r-md focus:z-10 focus:bg-primary focus:text-white text-lg"
              >
                Voted
              </button>
            </div>
              ...
              <Content
                svg={
                  <div class="flex justify-center">
                    <div
                      class="w-12 h-12 rounded-full overflow-hidden border-2 border-gray-300"
                      style={{
                        background: "rgb(80, 106, 244)",
                        overflow: "hidden",
                        borderRadius: "100%",
                      }}
                    >
                        ...
                        <div style={inside}>
                          ...
                          >
                            <g clip-path="url(#clip0)">
                              ...
                              <mask id="path3226027" fill="white">
                                <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
                                  d="M183.886 150.917C183.859 150.801 183.831 150.685 183.803 150.569C183.776 150.454 183.748 150.338 183.719 150.222L167.323 81.7855C167.306 81.7177 167.29 81.6499 167.274 81.5821C167.258 81.5142 167.242 81.4465 167.225 81.3787L167.152 81.0752L167.151 81.0755C156.933 39.6308 115.156 14.1472 73.5821 24.1081C32.0078 34.0689 6.31547 75.7174 15.9883 117.293L15.9863 117.293L32.9776 188.211L32.9916 188.208C43.5944 229.112 85.0616 254.149 126.329 244.261C167.597 234.374 193.216 193.264 184.131 151.996L184.144 151.993L183.886 150.917Z"
                        ...
                        <div style={inside}>
                          ...
                          >
                            <g clip-path="url(#clip0)">
                              ...
                              <mask id="path9444870" fill="white">
                                <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
                                  d="M183.886 150.917C183.859 150.801 183.831 150.685 183.803 150.569C183.776 150.454 183.748 150.338 183.719 150.222L167.323 81.7855C167.306 81.7177 167.29 81.6499 167.274 81.5821C167.258 81.5142 167.242 81.4465 167.225 81.3787L167.152 81.0752L167.151 81.0755C156.933 39.6308 115.156 14.1472 73.5821 24.1081C32.0078 34.0689 6.31547 75.7174 15.9883 117.293L15.9863 117.293L32.9776 188.211L32.9916 188.208C43.5944 229.112 85.0616 254.149 126.329 244.261C167.597 234.374 193.216 193.264 184.131 151.996L184.144 151.993L183.886 150.917Z"
                        ...
                        <div style={inside}>
                          ...
                          >
                            <g clip-path="url(#clip0)">
                              ...
                              <mask id="path7012001" fill="white">
                                <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
                                  d="M183.886 150.917C183.859 150.801 183.831 150.685 183.803 150.569C183.776 150.454 183.748 150.338 183.719 150.222L167.323 81.7855C167.306 81.7177 167.29 81.6499 167.274 81.5821C167.258 81.5142 167.242 81.4465 167.225 81.3787L167.152 81.0752L167.151 81.0755C156.933 39.6308 115.156 14.1472 73.5821 24.1081C32.0078 34.0689 6.31547 75.7174 15.9883 117.293L15.9863 117.293L32.9776 188.211L32.9916 188.208C43.5944 229.112 85.0616 254.149 126.329 244.261C167.597 234.374 193.216 193.264 184.131 151.996L184.144 151.993L183.886 150.917Z"
                        ...
                        <div style={inside}>
                          ...
                          >
                            <g clip-path="url(#clip0)">
                              ...
                              <mask id="path5292896" fill="white">
                                <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
                                  d="M183.886 150.917C183.859 150.801 183.831 150.685 183.803 150.569C183.776 150.454 183.748 150.338 183.719 150.222L167.323 81.7855C167.306 81.7177 167.29 81.6499 167.274 81.5821C167.258 81.5142 167.242 81.4465 167.225 81.3787L167.152 81.0752L167.151 81.0755C156.933 39.6308 115.156 14.1472 73.5821 24.1081C32.0078 34.0689 6.31547 75.7174 15.9883 117.293L15.9863 117.293L32.9776 188.211L32.9916 188.208C43.5944 229.112 85.0616 254.149 126.329 244.261C167.597 234.374 193.216 193.264 184.131 151.996L184.144 151.993L183.886 150.917Z"
                        ...
                        <div style={inside}>
                          ...
                          >
                            <g clip-path="url(#clip0)">
                              ...
                              <mask id="path2476716" fill="white">
                                <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
                                  d="M183.886 150.917C183.859 150.801 183.831 150.685 183.803 150.569C183.776 150.454 183.748 150.338 183.719 150.222L167.323 81.7855C167.306 81.7177 167.29 81.6499 167.274 81.5821C167.258 81.5142 167.242 81.4465 167.225 81.3787L167.152 81.0752L167.151 81.0755C156.933 39.6308 115.156 14.1472 73.5821 24.1081C32.0078 34.0689 6.31547 75.7174 15.9883 117.293L15.9863 117.293L32.9776 188.211L32.9916 188.208C43.5944 229.112 85.0616 254.149 126.329 244.261C167.597 234.374 193.216 193.264 184.131 151.996L184.144 151.993L183.886 150.917Z"
                        ...
                        <div style={inside}>
                          ...
                          >
                            <g clip-path="url(#clip0)">
                              ...
                              <mask id="path8730278" fill="white">
                                <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
                                  d="M183.886 150.917C183.859 150.801 183.831 150.685 183.803 150.569C183.776 150.454 183.748 150.338 183.719 150.222L167.323 81.7855C167.306 81.7177 167.29 81.6499 167.274 81.5821C167.258 81.5142 167.242 81.4465 167.225 81.3787L167.152 81.0752L167.151 81.0755C156.933 39.6308 115.156 14.1472 73.5821 24.1081C32.0078 34.0689 6.31547 75.7174 15.9883 117.293L15.9863 117.293L32.9776 188.211L32.9916 188.208C43.5944 229.112 85.0616 254.149 126.329 244.261C167.597 234.374 193.216 193.264 184.131 151.996L184.144 151.993L183.886 150.917Z"
